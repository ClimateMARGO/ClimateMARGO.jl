...
Try out the MARGO model by running our [Pluto](https://plutojl.org)-based [**notebook**](https://climatemargo.github.io/interactive/introduction.html)! You can run the notebook locally or using binder (binder is not always reliable).
