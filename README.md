...
Try out the MARGO model by running our [Pluto](https://plutojl.org)-based [**notebook**](https://margo.plutojl.org/introduction.html)! You can run the notebook locally or using binder (binder is not always reliable).
